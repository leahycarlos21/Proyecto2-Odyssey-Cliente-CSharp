...
namespace Prueba
{
    internal class analizador
    {
        ...
        private EspectroControl _spectrum;         //spectrum dispay control
        ...
        //ctor
        public analizador(ProgressBar left, ProgressBar right, EspectroControl spectrum, ComboBox devicelist, Chart chart)
        {
            _fft = new float[8192];
            _lastlevel = 0;
            _hanctr = 0;
